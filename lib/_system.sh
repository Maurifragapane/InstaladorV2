...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Descargando el código del Canal Vem Fazer...${GRAY_LIGHT}"
  printf "\n\n"
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos a actualizar el sistema del Canal Vem Fazer...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos a eliminar el Canal Vem Fazer...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Remoción de la Instancia/Empresa ${empresa_delete} realizado con éxito ...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos a bloquear el Canal Vem Fazer...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos a Desbloquear el Canal Vem Fazer...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos a cambiar los dominios del Canal Vem Fazer...${GRAY_LIGHT}"
  printf "\n\n"
